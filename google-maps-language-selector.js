    ...
    function createButtonElement() {
        ...
        function navigateWithLanguage(code) {
            ...
            try {
                ...
                logger.error('URL construction failed, falling back to manual query update.', error);
                try {
                    ...
                    window.location.href = window.location.href + separator + 'hl=' + encodeURIComponent(code);
                }
            }
        }
