...
(function () {
  ...
  function handleNotInterestedClick(e) {
    ...
    const thisContainer = e.currentTarget.closest(
    ...
    const menuItemSelector =
      'div[role="menu"] div[role="button"], div[role="menu"] span';
        ...
        const pathsData = [
          {
            ...
            stroke: "currentColor",
            fill: "none",
            extra: { "stroke-linecap": "round", "stroke-width": "1.5" },
          },
          {
  ...
  function processPosts() {
    ...
    const buttonRows = document.querySelectorAll(
      "div.x6s0dn4.xamitd3.x40hh3e.x78zum5.x1q0g3np.x1xdureb.x1fc57z9.x1hm9lzh.xvijh9v"
    );
